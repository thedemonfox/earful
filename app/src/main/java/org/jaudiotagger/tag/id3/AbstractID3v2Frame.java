...
public abstract class AbstractID3v2Frame extends AbstractTagFrame implements TagTextField
{
    ...
    public AbstractID3v2Frame(String identifier)
    {
        ...
        if(Constants.DEBUG) logger.info("Created empty frame of type" + identifier);
    }
            ...
            throws InvalidFrameException, InvalidDataTypeException
    {
        ...
        {
            if(Constants.DEBUG) logger.info(getLoggingFilename() + ":" + "Identifier not recognised:" + identifier + " using FrameBodyUnsupported");
            try
            {
        ...
        //Private Constructor should not happen
        catch (IllegalAccessException iae)
        {
    ...
    protected AbstractID3v2FrameBody readBody(String identifier, AbstractID3v2FrameBody body) throws InvalidFrameException
    {
        ...
        {
            if(Constants.DEBUG) logger.info("Identifier not recognised:" + identifier + " unable to create framebody");

...
*/
     ...
     * @param frame
     */
    private void addNewFrameOrAddField(List<TagField> list, HashMap<String, Object> frameMap, AbstractID3v2Frame existingFrame, AbstractID3v2Frame frame)
    {
        /**
...
*/
    ...
    {
        byteBuffer.rewind();
        if(Constants.DEBUG) logger.info("ByteBuffer pos:" + byteBuffer.position() + ":limit" + byteBuffer.limit() + ":cap" + byteBuffer.capacity());

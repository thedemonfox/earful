...
public class ID3v24Tag extends AbstractID3v2Tag
{
    ...
    @Override
       protected void copyFrameIntoMap(String id, AbstractID3v2Frame newFrame)
       {
           ...
           if (frameMap.containsKey(newFrame.getIdentifier()))
           {
               ...
               {
                    List<AbstractID3v2Frame> list = (List<AbstractID3v2Frame>)o;
                    list.add(newFrame);
               }
           }
           else
    ...
    public void read(ByteBuffer byteBuffer) throws TagException
    {
        ...
        if(Constants.DEBUG) logger.info(getLoggingFilename() + ":" + "Reading ID3v24 tag");
        ...
        if(Constants.DEBUG) logger.info(getLoggingFilename() + ":" + "Reading tag from file size set in header is" + size);
    ...
    protected void readFrames(ByteBuffer byteBuffer, int size)
    {
        ...
        while (byteBuffer.position() <= size)
        {
            ...
            {
                if(Constants.DEBUG) logger.info(getLoggingFilename() + ":" + "Invalid Frame Identifier:" + ifie.getMessage());
                this.invalidFrames++;

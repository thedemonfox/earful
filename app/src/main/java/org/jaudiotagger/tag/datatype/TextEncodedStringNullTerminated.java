...
public class TextEncodedStringNullTerminated extends AbstractString
{
    ...
    public void readByteArray(byte[] arr, int offset) throws InvalidDataTypeException
    {
        ...
        //Set Size so offset is ready for next field (includes the null terminator)
        if(Constants.DEBUG) logger.info("Read NullTerminatedString:" + value + " size inc terminator:" + size);
    }
    ...
    {
        if(Constants.DEBUG) logger.info("Writing NullTerminatedString." + value);
        byte[] data;

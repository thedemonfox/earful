...
public class StringFixedLength extends AbstractString
{
    ...
    {
        if(Constants.DEBUG) logger.info("Reading from array from offset:" + offset);
        try
        {
            ...
            if(Constants.DEBUG) logger.finest("Array length is:" + arr.length + "offset is:" + offset + "Size is:" + size);
        ...
        if(Constants.DEBUG) logger.info("Read StringFixedLength:" + value);
    }

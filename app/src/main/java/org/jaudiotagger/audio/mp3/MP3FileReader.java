...
public class MP3FileReader extends AudioFileReader
{
    ...
    public AudioFile read(File f) throws IOException, TagException, InvalidAudioFrameException
    {
     ...
     */
    /*
    public AudioFile readMustBeWritable(File f) throws IOException, TagException, InvalidAudioFrameException
    {
